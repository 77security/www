...
<RecentArticles />
<CardGrid>
  <Card title="Latest Intelligence" icon="random">
    [View all research updates](/blog/)
  </Card>
  <Card title="AI Security Pillars" icon="open-book">
    [Core defensive frameworks](/ai-security/pillars/)
  </Card>
  <Card title="Technical Toolbox" icon="setting">
    [Security tools & scripts](/resources/tools/)
  </Card>
</CardGrid>
</section>
